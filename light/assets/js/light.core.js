...
light.core = new function () {
    ...
    this.html = new function () {
        ...
        this.insertAdjacentHTML = function (id_or_htmlElement, html) {
            ...
            if (html && typeof html === 'string') {
                ...
                try {
                    ...
                    if (typeof id_or_htmlElement === 'string') {

                        htmlElement = document.getElementById(id_or_htmlElement);

                    } else if (id_or_htmlElement instanceof HTMLElement) {

                        htmlElement = id_or_htmlElement;
                    }
                ...
                let errorMessage = `No HTML code as argument in function`;
                console.log(errorMessage);
            }
    ...
    this.text = new function () {
        ...
        support@zaggys.com
        support.abc@zaggys.com
        Suppor123_myr.test@zaggys_2.com.hr
        ...
        */
    ...
    this.fetch = new function () {
        ...
        this.submit = async function (div, url = '') {
            ...
            var body = await light.core.template.div_to_json(div);
            var response = await light.core.fetch.post(url, body);
            return response;
    ...
    this.template = new function () {
        ...
        this.post = async function (el, url, data) {
            ...
            var json = await ajax.post_json(url, data);

            js.template.run(el, json, template, load);
        }
        ...
        this.get = async function (el, url) {
            ...
            var json = await ajax.get_json(url);
      ...
      */
        ...
        */
        ...
        // convert all intputs with data-light_id to json
        this.div_to_json = async function (div) {

            var div = document.getElementById(div);
            var inputs = div.querySelectorAll('[data-light_id]');

            // get json body
            var json = {};
            await inputs.forEach(async (e) => {
                json[e.dataset.light_id] = e.value;
            });
